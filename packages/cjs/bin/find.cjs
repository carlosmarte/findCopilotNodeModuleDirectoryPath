...
const { findCopilot, DEFAULT_CANDIDATES } = require('../src/index.cjs');

const HELP = `find-copilot-cjs — locate the closest installed @github/copilot* module (CommonJS)

Usage:
  find-copilot-cjs [options] [moduleName ...]
